...
///
/// Mirrors [`FirestoreQuerySupport::query_doc`]: the fluent `.plan()` and `.sync()` terminals on
/// [`FirestoreIndexesBuilder`](crate::index_builder::FirestoreIndexesBuilder) are the only
/// callers.
#[cfg(feature = "admin")]
#[async_trait]
